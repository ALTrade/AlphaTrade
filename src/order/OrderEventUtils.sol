...
library OrderEventUtils {
    ...
    function emitOrderCreated(EventEmitter eventEmitter, bytes32 key, Order.Props memory order) external {
        ...
        eventEmitter.emitEventLog2("OrderCreated", key, Cast.toBytes32(order.account()), eventData);
    }
    ...
    function emitOrderExecuted(
        ...
        eventEmitter.emitEventLog2("OrderExecuted", key, Cast.toBytes32(account), eventData);
    }
    ...
    function emitOrderUpdated(
        ...
        eventEmitter.emitEventLog2("OrderUpdated", key, Cast.toBytes32(account), eventData);
    }
    ...
    function emitOrderSizeDeltaAutoUpdated(
        ...
        eventEmitter.emitEventLog1("OrderSizeDeltaAutoUpdated", key, eventData);
    }
    ...
    function emitOrderCollateralDeltaAmountAutoUpdated(
        ...
        eventEmitter.emitEventLog1("OrderCollateralDeltaAmountAutoUpdated", key, eventData);
    }
    ...
    function emitOrderCancelled(
        ...
        eventEmitter.emitEventLog2("OrderCancelled", key, Cast.toBytes32(account), eventData);
    }
    ...
    function emitOrderFrozen(
        ...
        eventEmitter.emitEventLog2("OrderFrozen", key, Cast.toBytes32(account), eventData);
    }
}
