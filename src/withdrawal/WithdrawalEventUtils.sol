...
library WithdrawalEventUtils {
    ...
    function emitWithdrawalCreated(
        ...
        eventEmitter.emitEventLog2("WithdrawalCreated", key, Cast.toBytes32(withdrawal.account()), eventData);
    }
    ...
    function emitWithdrawalExecuted(
        ...
        eventEmitter.emitEventLog2("WithdrawalExecuted", key, Cast.toBytes32(account), eventData);
    }
    ...
    function emitWithdrawalCancelled(
        ...
        eventEmitter.emitEventLog2("WithdrawalCancelled", key, Cast.toBytes32(account), eventData);
    }
}
