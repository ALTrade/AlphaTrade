...
library DepositEventUtils {
    ...
    function emitDepositCreated(
        ...
        eventEmitter.emitEventLog2("DepositCreated", key, Cast.toBytes32(deposit.account()), eventData);
    }
    ...
    function emitDepositExecuted(
        ...
        eventEmitter.emitEventLog2("DepositExecuted", key, Cast.toBytes32(account), eventData);
    }
    ...
    function emitDepositCancelled(
        ...
        eventEmitter.emitEventLog2("DepositCancelled", key, Cast.toBytes32(account), eventData);
    }
}
