...
library PositionEventUtils {
    ...
    function emitPositionIncrease(PositionIncreaseParams memory params) external {
        ...
        eventData.uintItems.setItem(
            5, "longTokenClaimableFundingAmountPerSize", params.position.longTokenClaimableFundingAmountPerSize()
        );
        eventData.uintItems.setItem(
            6, "shortTokenClaimableFundingAmountPerSize", params.position.shortTokenClaimableFundingAmountPerSize()
        );
        ...
        params.eventEmitter.emitEventLog1("PositionIncrease", Cast.toBytes32(params.position.account()), eventData);
    }
    ...
    function emitPositionDecrease(
        ...
        eventData.uintItems.setItem(
            5, "longTokenClaimableFundingAmountPerSize", position.longTokenClaimableFundingAmountPerSize()
        );
        eventData.uintItems.setItem(
            6, "shortTokenClaimableFundingAmountPerSize", position.shortTokenClaimableFundingAmountPerSize()
        );
        ...
        eventEmitter.emitEventLog1("PositionDecrease", Cast.toBytes32(position.account()), eventData);
    }
    ...
    function emitInsolventCloseInfo(
        ...
        eventEmitter.emitEventLog("InsolventClose", eventData);
    }
    ...
    function emitInsufficientFundingFeePayment(
        ...
        eventEmitter.emitEventLog1("InsufficientFundingFeePayment", Cast.toBytes32(market), eventData);
    }
    ...
    function _emitPositionFees(
        ...
        eventData.uintItems.setItem(
            17, "borrowingFeeAmountForFeeReceiver", fees.borrowing.borrowingFeeAmountForFeeReceiver
        );
        ...
        eventEmitter.emitEventLog1(eventName, Cast.toBytes32(market), eventData);
    }
}
