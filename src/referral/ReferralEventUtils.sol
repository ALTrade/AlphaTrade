...
library ReferralEventUtils {
    ...
    function emitAffiliateRewardUpdated(
        ...
        eventEmitter.emitEventLog2(
            "AffiliateRewardUpdated", Cast.toBytes32(market), Cast.toBytes32(affiliate), eventData
        );
    }
    ...
    function emitAffiliateRewardClaimed(
        ...
        eventEmitter.emitEventLog1("AffiliateRewardClaimed", Cast.toBytes32(affiliate), eventData);
    }
}
