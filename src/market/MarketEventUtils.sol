...
library MarketEventUtils {
    ...
    function emitMarketPoolValueInfo(
        ...
        eventEmitter.emitEventLog1("MarketPoolValueInfo", Cast.toBytes32(market), eventData);
    }
    ...
    function emitMarketPoolValueUpdated(
        ...
        eventEmitter.emitEventLog1("MarketPoolValueUpdated", Cast.toBytes32(market), eventData);
    }
    ...
    function emitPoolAmountUpdated(
        ...
        eventEmitter.emitEventLog1("PoolAmountUpdated", Cast.toBytes32(market), eventData);
    }
    ...
    function emitSwapImpactPoolAmountUpdated(
        ...
        eventEmitter.emitEventLog1("SwapImpactPoolAmountUpdated", Cast.toBytes32(market), eventData);
    }
    ...
    function emitPositionImpactPoolDistributed(
        ...
        eventEmitter.emitEventLog1("PositionImpactPoolDistributed", Cast.toBytes32(market), eventData);
    }
    ...
    function emitPositionImpactPoolAmountUpdated(
        ...
        eventEmitter.emitEventLog1("PositionImpactPoolAmountUpdated", Cast.toBytes32(market), eventData);
    }
    ...
    function emitOpenInterestUpdated(
        ...
        eventEmitter.emitEventLog1("OpenInterestUpdated", Cast.toBytes32(market), eventData);
    }
    ...
    function emitVirtualSwapInventoryUpdated(
        ...
        eventEmitter.emitEventLog2("VirtualSwapInventoryUpdated", Cast.toBytes32(market), virtualMarketId, eventData);
    }
    ...
    function emitVirtualPositionInventoryUpdated(
        ...
        eventEmitter.emitEventLog2("VirtualPositionInventoryUpdated", Cast.toBytes32(token), virtualTokenId, eventData);
    }
    ...
    function emitOpenInterestInTokensUpdated(
        ...
        eventEmitter.emitEventLog1("OpenInterestInTokensUpdated", Cast.toBytes32(market), eventData);
    }
    ...
    function emitCollateralSumUpdated(
        ...
        eventEmitter.emitEventLog1("CollateralSumUpdated", Cast.toBytes32(market), eventData);
    }
    ...
    function emitBorrowingFactorUpdated(
        ...
        eventEmitter.emitEventLog1("CumulativeBorrowingFactorUpdated", Cast.toBytes32(market), eventData);
    }
    ...
    function emitFundingFeeAmountPerSizeUpdated(
        ...
        eventEmitter.emitEventLog1("FundingFeeAmountPerSizeUpdated", Cast.toBytes32(market), eventData);
    }
    ...
    function emitClaimableFundingAmountPerSizeUpdated(
        ...
        eventEmitter.emitEventLog1("ClaimableFundingAmountPerSizeUpdated", Cast.toBytes32(market), eventData);
    }
    ...
    function emitClaimableFundingUpdated(
        ...
        eventEmitter.emitEventLog1("ClaimableFundingUpdated", Cast.toBytes32(account), eventData);
    }
    ...
    function emitFundingFeesClaimed(
        ...
        eventEmitter.emitEventLog1("FundingFeesClaimed", Cast.toBytes32(account), eventData);
    }
    ...
    function emitClaimableCollateralUpdated(
        ...
        eventEmitter.emitEventLog1("ClaimableCollateralUpdated", Cast.toBytes32(account), eventData);
    }
    ...
    function emitCollateralClaimed(
        ...
        eventEmitter.emitEventLog1("CollateralClaimed", Cast.toBytes32(account), eventData);
    }

    function emitUiFeeFactorUpdated(EventEmitter eventEmitter, address account, uint256 uiFeeFactor) external {
        EventUtils.EventLogData memory eventData;
        ...
        eventEmitter.emitEventLog1("UiFeeFactorUpdated", Cast.toBytes32(account), eventData);
    }
}
